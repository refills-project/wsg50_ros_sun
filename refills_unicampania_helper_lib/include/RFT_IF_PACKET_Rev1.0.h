...
// Cutoff Frq.
#define CUTOFF_500Hz		(1)
#define CUTOFF_300Hz		(2)
#define CUTOFF_200Hz		(3)
#define CUTOFF_150Hz		(4)
#define CUTOFF_100Hz		(5)
#define CUTOFF_50Hz		(6)
#define CUTOFF_40Hz		(7)
#define CUTOFF_30Hz		(8)
#define CUTOFF_20Hz		(9)
#define CUTOFF_10Hz	(10)
#define CUTOFF_5Hz	(11)
#define CUTOFF_3Hz	(12)
#define CUTOFF_2Hz	(13)
#define CUTOFF_1Hz	(14)
...
//
#define FORCE_DIVIDER (50.0f)
#define TORQUE_DIVIDER (2000.0f)
